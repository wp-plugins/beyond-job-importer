...
Beyond Job Importer Plugin Import job from Beyond API according to your given parameter.
...
1. Upload the **beyond-job-importer** folder to the /wp-content/plugins/ directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go **Beyond Importer** in admin menu and add new importer search parameter click save button.
4. In importer list click **Featch Now** link.

== Frequently Asked Questions ==

* **Where to get affiliate ID?**

  Don't you have such a key ? Request one : http://about.beyond.com/affiliate
...
1. screenshot-1.png  : screen shot admin Beyond job importer add section
2. screenshot-2.png  : screen shot admin Beyond job importer list.
